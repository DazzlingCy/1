export const CITIES = [
  { id: '1', name: '杭州', englishName: 'Hangzhou', continent: '中国', x: 75, y: 36, image: 'https://images.unsplash.com/photo-1628876404838-89c5f4925e0b?auto=format&fit=crop&q=80&w=400&h=300', routes: 14, spots: 92, completed: 0 },
  ...
  { id: '4', name: '南京', englishName: 'Nanjing', continent: '中国', x: 75, y: 34.5, image: 'https://images.unsplash.com/photo-1574514936359-fec42475e205?auto=format&fit=crop&q=80&w=400&h=300', routes: 12, spots: 71, completed: 0 },
  { id: '5', name: '西安', englishName: 'Xi\'an', continent: '中国', x: 73, y: 35, image: 'https://images.unsplash.com/photo-1599576751280-992e5c8dbac1?auto=format&fit=crop&q=80&w=400&h=300', routes: 11, spots: 66, completed: 0 },
  ...
  { id: '8', name: '伦敦', englishName: 'London', continent: '欧洲', x: 45, y: 25, image: 'https://images.unsplash.com/photo-1513635269975-5969336ac1cb?auto=format&fit=crop&q=80&w=400&h=300', routes: 22, spots: 140, completed: 0 },
